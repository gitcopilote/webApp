        ...
        @foreach($tasks as $task)
            <tr class="bg-white border-b white:bg-gray-900 ">
                ...
                <td class="px-6 py-4">
                    ...
                    {{-- @Can('administrateur')
                    <a href="{{ route('task.unassign',['task' => $task->id ]) }}" class="font-medium bg-red-500 px-2 py2 text-white rounded-md hover:underline">desassigné</a>
                     @endcan --}}


                     @if ($task->status != 'desassigné')
                     @can('administrateur')
                     <a href="{{ route('task.unassign',['task' => $task->id ]) }}" class="font-medium bg-red-500 px-2 py2 text-white rounded-md hover:underline">desassigné</a>
                     @endcan
                     @endif
