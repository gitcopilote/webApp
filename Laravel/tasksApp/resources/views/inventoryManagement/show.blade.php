...
<div class="container mx-auto px-4">
    ...
    <form>
        ...
        <div class="mb-4">
            ...
            <input readonly type="text"  value="{{old('Fournisseur') ?? $stock->supplier }}" name="Fournisseur" id="Fournisseur" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
        ...
        <div class="mb-4">
            ...
            <input readonly type="text" value="{{ old('Produit') ?? $stock->product }}" name="Produit" id="Produit" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
        ...
        <div class="mb-4">
            ...
            <input readonly type="number"  value="{{ old('Quantité') ?? $stock->quantity}}"name="Quantité" id="Quantité" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5
