...
@endif
    ...
    <div class="container mx-auto px-4">
        <h1 class="text-3xl font-semibold mb-6">Liste des transactions</h1>
        <a href="{{ route('transactions.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md mb-4 inline-block">Ajouter
            une transaction</a>
        <div class="overflow-x-auto">
            <table class="table-auto w-full border-collapse">
                <thead>
                    <tr class="bg-gray-200">
                        <th class="px-6 py-3 border-b border-gray-300 text-left text-sm font-bold uppercase">ID</th>
                        <th class="px-6 py-3 border-b border-gray-300 text-left text-sm font-bold uppercase">Nom du maintenancier</th>
                        <th class="px-6 py-3 border-b border-gray-300 text-left text-sm font-bold uppercase">Produit</th>
                        <th class="px-6 py-3 border-b border-gray-300 text-left text-sm font-bold uppercase">transaction
                        </th>
